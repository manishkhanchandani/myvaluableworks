...
'   Description:            This script Login you on Ebay.com website with SSL using curl in php and then take to summary page.
...
if($_POST['ebay_user_id'])
{
	...
	$cookie_file_path = "C:\Apache\Apache\htdocs\cookie.txt"; // Please set your Cookie File path
